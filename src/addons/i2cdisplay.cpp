...
bool I2CDisplayAddon::isDisplayPowerOff()
{
	...
	if (!displaySaverTimeout && !isFocusModeEnabled)
		return false;
	...
	if (configMode)
	{
		...
		{ // has button been pressed (held and released)?
			...
			case (GAMEPAD_MASK_B1):
				prevDisplayMode =
					prevDisplayMode == I2CDisplayAddon::DisplayMode::BUTTONS ? I2CDisplayAddon::DisplayMode::CONFIG_INSTRUCTION : I2CDisplayAddon::DisplayMode::BUTTONS;
				break;
			case (GAMEPAD_MASK_B2):
				prevDisplayMode =
					prevDisplayMode == I2CDisplayAddon::DisplayMode::SPLASH ? I2CDisplayAddon::DisplayMode::CONFIG_INSTRUCTION : I2CDisplayAddon::DisplayMode::SPLASH;
				break;
			default:
